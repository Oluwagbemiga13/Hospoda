...
/**
 * This program imitates pub. It creates customers and drinks. It sells drinks
 * to customer and count balances of pub and customers. It also keeps track of
 * drinks avalible It is able to keep track of orders and prints bill. It needs
 * to be redone so you will have more objects like "reciept, ledger, walet ect.
 * -> First you need to learn inheritance and polymorphism.
 *
 * @author Daniel
 */
public class Hospoda {
    ...
    public void sell(Customer c, Drink d) {
        ...
        if (d.amountOfDrink < 1) {
            System.out.println("There is " + d.amountOfDrink + " " + d.nameOfDrink + " left");
        }
        if (d.amountOfDrink == 1) {
            System.out.println("There last " + d.nameOfDrink + " !");
        }
    ...
    // At least it seems to be simple
    ...
    public static void main(String[] args) {
        ...
        Drink milk = new Drink("Mlíčko", false, 3, 5.0);
        //System.out.println(water.nameOfDrink + " was created.");
